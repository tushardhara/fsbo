...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url('js/jquery.scrollTo.min');?>"></script>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=641035262659975&version=v2.0";
