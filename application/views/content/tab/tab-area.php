			<div class="tab-area clearfix">
				...
				<?php if($this->session->userdata('logged_in')['user_type'] == 'admin') { ?>
					...
					<a href="<?php echo site_url('profile/admin/mylist')?>"><div class="tab <?php echo $this->uri->segment(3) == 'mylist' ? 'active':''; ?>"><span class="icon-tab l"></span><span class="text l">All Listing</span></div></a>
					<a href="<?php echo site_url('profile/admin/settings')?>"><div class="tab <?php echo $this->uri->segment(3) == 'settings' ? 'active':''; ?>"><span class="icon-tab w"></span><span class="text w">Settings</span></div></a>
					<a href="<?php echo site_url('profile/admin/message')?>"><div class="tab <?php echo $this->uri->segment(3) == 'message' ? 'active':''; ?>"><span class="icon-tab w"></span><span class="text w">Message</span></div></a>
				...
				<?php }else if($this->session->userdata('logged_in')['user_type'] == 'moderator') { ?>
					...
					<a href="<?php echo site_url('profile/moderator/wishlist')?>"><div class="tab <?php echo $this->uri->segment(3) == 'wishlist' ? 'active':''; ?>"><span class="icon-tab w"></span><span class="text w">Wish List</span></div></a>
					<a href="<?php echo site_url('profile/moderator/message')?>"><div class="tab <?php echo $this->uri->segment(3) == 'message' ? 'active':''; ?>"><span class="icon-tab w"></span><span class="text w">Message</span></div></a>
				...
				<?php }else if($this->session->userdata('logged_in')['user_type'] == 'user') { ?>
					...
					<a href="<?php echo site_url('profile/user/wishlist')?>"><div class="tab <?php echo $this->uri->segment(3) == 'wishlist' ? 'active':''; ?>"><span class="icon-tab w"></span><span class="text w">Wish List</span></div></a>
				...
				<?php }else if($this->session->userdata('logged_in')['user_type'] == 'agent') { ?>
					...
					<a href="<?php echo site_url('profile/agent/wishlist')?>"><div class="tab <?php echo $this->uri->segment(3) == 'wishlist' ? 'active':''; ?>"><span class="icon-tab w"></span><span class="text w">Wish List</span></div></a>
